var countries=[
  ...
  for(let country of countries){
    ...
    if ("currencies" in countries) {
      currencyName=country.currencies[0].name 
    }
    // console.log(currencyName);
    let myCountries={countryName,population,capital,currencyName}
    arrCountries.push(myCountries)
  }
  var chinaCurrency=arrCountries.find(data=>data.countryName=="China")
  // console.log(chinaCurrency);
  // arrCountries.forEach(data => {console.log(data.countryName)})
  // var indiaData =arrCountries.find(data=>data.countryName=="India")
  // console.log(indiaData);
  // var chinaCurrency=arrCountries.find(data=>data.countryName=="China").currencies
  // console.log(chinaCurrency);

  var populationThreshold=arrCountries.filter(data=>data.population>20000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name.countryName))